        ...
        <div class="flex flex-1 justify-between sm:hidden">
            ...
            <div>
                <p class="text-sm text-gray-700 dark:text-gray-300 leading-5">
                    Mostrando
                    <span class="font-medium">{{ $movimientos->firstItem() }}</span>
                    a
                    <span class="font-medium">{{ $movimientos->lastItem() }}</span>
                    de
                    <span class="font-medium">{{ $movimientos->total() }}</span>
                    resultados
                </p>
            </div>
