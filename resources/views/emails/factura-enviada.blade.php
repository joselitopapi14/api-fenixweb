...
<body>
    <div class="container">
        ...
        <div class="empresa-info">
            ...
            @endif
            @if($empresa->telefono_fijo || $empresa->celular)
                <p><strong>Teléfono:</strong> {{ $empresa->telefono_fijo ?: $empresa->celular }}</p>
            @endif
            @if($empresa->email)
        ...
        <div class="factura-info">
            ...
            <div class="info-box">
                ...
                <p><strong>Documento:</strong> {{ $cliente->cedula_nit }}@if($cliente->dv)-{{ $cliente->dv }}@endif</p>
                @if($cliente->telefono_fijo || $cliente->celular)
                    <p><strong>Teléfono:</strong> {{ $cliente->telefono_fijo ?: $cliente->celular }}</p>
                @endif
        ...
        <div class="mensaje">
            <p>
                ...
                en formato ZIP que contiene el PDF de la representación gráfica, el XML oficial validado por la DIAN,
                y el documento adjunto (attached document) correspondiente.
            </p>
        </div>
        ...
        <div style="margin: 20px 0;">
            ...
            <ul style="color: #6c757d; font-size: 14px;">
                ...
                <li>El archivo ZIP adjunto contiene el PDF, XML oficial y attached document</li>
                ...
                @endif
                <li>El attached document es el contenedor oficial que valida el XML ante la DIAN</li>
            </ul>
        </div>
        ...
        @if($factura->cufe)
            <div style="background-color: #fff3cd; border: 1px solid #ffeaa7; border-radius: 5px; padding: 15px; margin: 20px 0;">
                ...
                <p style="margin: 0; color: #856404; font-size: 14px;">
                    ...
                    {{-- Nota: tipo_ambiente no existe en el modelo Empresa, usar ambiente de producción por defecto --}}
        ...
        <div class="footer">
            ...
            <p>Para consultas o soporte, contáctese con {{ $empresa->razon_social }}</p>
            @if($empresa->telefono_fijo || $empresa->celular)
                <p>Teléfono: {{ $empresa->telefono_fijo ?: $empresa->celular }}</p>
            @endif
            @if($empresa->email)
